window.onload = function(){
    ...
    function start_click(){
        game_running = true;
        document.getElementById("status").innerHTML = "Begin by moving your mouse over the &quot;S&quot;. "+score;
        var elements = document.getElementsByClassName("boundary");
        for(var i = 0; i < elements.length; i++){
    ...
    function cheat(){
        ...
        if(game_running == false){
            ...
            game_running = false;
            score-=10;
            document.getElementById("status").innerHTML = "Nice try but that's cheating. "+score;
            var elements = document.getElementsByClassName("boundary");
            for(var i = 0; i < elements.length; i++)
            elements[i].style.backgroundColor = "red";
